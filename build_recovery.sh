...
pack_spi_full_image()
{
	...
	# ODROID-GO2 dtb
	dd if=./arch/arm/dts/rg351mp-uboot.dtb of=${OUT}/spi_recovery.img bs=512 seek=8192 count=200 conv=fsync,notrunc
...
pack_recovery_sdcard_img()
{
	...
	sudo cp ./arch/arm/dts/rg351mp-uboot.dtb ${MNT}/rk3326-odroidgo2-linux.dtb
	sudo cp ./arch/arm/dts/rg351mp-uboot.dtb ${MNT}/rk3326-odroidgo2-linux-v11.dtb
	...
	sudo cp ./arch/arm/dts/rg351mp-uboot.dtb ${MNT}/rk3326-odroidgo3-linux.dtb
